// ==UserScript==
// @name         SIGAA Ultimate 2 - Login
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Tela de login moderna, responsiva e com limpeza de sessão automática.
// @author       Gusttavo
...
(function() {
    ...
    const css = `
        ...
        body > table, #container, #conteudo, .tabela, center, #logar-no-sistema {
            display: none !important;
        }

        body {
            background: linear-gradient(rgba(14, 44, 78, 0.85), rgba(14, 44, 78, 0.95)), 
        ...
        .logo-text { font-size: 1.8rem; font-weight: 800; color: #0e2c4e; letter-spacing: -0.025em; line-height: 1; }
        .welcome-title { font-size: 1.25rem; font-weight: 600; color: #374151; }
        ...
        .forgot-link {
            ...
            font-weight: 500; color: #2563eb; text-decoration: none; margin-top: 4px;
        }
        ...
        .submit-btn:hover { background-color: #1a416e; transform: translateY(-1px); }
        ...
        .badge-link:hover { border-color: #93c5fd; color: #2563eb; background: white; }
        ...
        .card-link:hover .caret { color: #3b82f6; }
    ...
    <div class="login-card">
        <div class="col-left">
            <div class="logo-area">
                <div class="logo-flex">
                    <i class="ph ph-student" style="font-size: 2.2rem; color: #0e2c4e;"></i>
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        eyeIcon.classList.replace(
            isPass ? 'ph-eye' : 'ph-eye-slash', 
            isPass ? 'ph-eye-slash' : 'ph-eye'
        );
    });
