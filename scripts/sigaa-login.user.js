...
(function() {
    ...
    const PALETTES = {
        ufc: { name: "UFC Clássico", primary: '#0e2c4e', hover: '#1a416e', bg_overlay: 'rgba(14, 44, 78, 0.9)', text_color: '#0e2c4e' },
        rocket: { name: "Rocketseat", primary: '#8257e6', hover: '#996DFF', bg_overlay: 'rgba(130, 87, 230, 0.9)', text_color: '#8257e6' },
        matrix: { name: "Matrix", primary: '#059669', hover: '#10b981', bg_overlay: 'rgba(6, 78, 59, 0.9)', text_color: '#064e3b' },
        orange: { name: "Sunset", primary: '#ea580c', hover: '#f97316', bg_overlay: 'rgba(154, 52, 18, 0.9)', text_color: '#c2410c' }
    };
